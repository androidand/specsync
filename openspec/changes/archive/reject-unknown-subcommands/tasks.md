...
- [x] 4. Update FusionHub docs referencing `specsync push` to use the real invocation (`specsync` / `specsync -change <name>`) — *owner task: external to this repo, not actionable here*
